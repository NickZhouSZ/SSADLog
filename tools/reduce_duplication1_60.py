...
log_file = "./data/split/BGL_test10_1.log"
#log_file = "./data/split/Spirit1G_train80.log"
#log_file = "./data/split/Thunderbird10M_train80.log"
#output_log_file = "./data/split/BGL_train80_reduced_60.log"
output_log_file = "./data/split/BGL_test10_1_reduced_60.log"
...
def remove_duplicates(input_file, output_file, recent_lines):
    ...
    with open(input_file, mode="r", encoding='utf8',errors='ignore') as file:
        ...
        for line_number, line in enumerate(file, start=1):
            ...
            if cleanLine not in recent_lines:
                recent_lines.append(cleanLine)
                out_tr.append(line)
                out_ind +=1
...
if __name__ == '__main__':
    ...
    remove_duplicates(log_file, output_log_file, recent_lines)
