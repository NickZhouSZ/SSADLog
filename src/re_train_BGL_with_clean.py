...
# 从JSON文件中读取日志数据
json_file_path = 'train_dataset_b_new1.json'
best_model_path =        're_train_BGL_with_clean_best_model'
final_model_path =        're_train_BGL_with_clean_final_model'
...
###### big change for load state from saved model
model_name = 'bert-base-uncased'
tokenizer = BertTokenizer.from_pretrained(model_name)
...
for epoch in range(num_epochs):
    ...
    train_data, test_data = train_test_split(log_data, test_size=0.5, random_state=42)
