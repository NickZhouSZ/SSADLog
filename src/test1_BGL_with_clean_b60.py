...
test_file_path = 'test1_dataset_b_60.json'
config_path =       'train_BGL_with_clean_best_model/config.json'
model_path =        'train_BGL_with_clean_best_model/pytorch_model.bin'
mismatch_file_path = 'test1_b60_mismatch.json'
...
for index in mismatch_indices:
    ...
    mismatched_logs.append(log_data[index])  # Store the mismatched log data
    print("-----")

# Save the mismatched logs to a JSON file
with open(mismatch_file_path, 'w') as file:
    json.dump(mismatched_logs, file, indent=4)
